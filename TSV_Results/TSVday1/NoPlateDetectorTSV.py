...
if __name__ == '__main__':
	...
	lis = glob.glob(r'E:\0NewDev\SIH\CB31_CyberKnights\Day1\\*.jpg')
		...
		if ret:
			...
			if ret[0]:
				...
				for res in ress:
					...
					data.append([(img.split('\\')[-1]) , [res[1],res[0], res[1]+res[2],res[0]+res[3]]  , "plate"])
	...
	with open('Plateoutput.tsv', 'w', newline='') as f_output:
