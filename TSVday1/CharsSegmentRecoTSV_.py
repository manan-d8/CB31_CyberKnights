...
import time
>>>>>>> f72c20cddab058e8339765618689d6b2f981f1a9
...
=======
		...
		self.modelWeights = r"weights\YoloV3SIH(Segmentation)_final.weights"
		self.net = cv2.dnn.readNetFromDarknet(self.modelConfiguration, self.modelWeights)
		# self.net.setPreferableBackend(cv2.dnn.DNN_BACKEND_CUDA)
		# self.net.setPreferableTarget(cv2.dnn.DNN_TARGET_CUDA)
		self.net.setPreferableBackend(cv2.dnn.DNN_BACKEND_OPENCV)
...
=======
	def LoadKerasModel(self):
		...
		self.model_Res = keras.models.load_model(r'weights/ResNet_Epoch_20.hdf5')
		self.model_ResV2 = keras.models.load_model(r'weights/ResNetV2_Epoch_20.hdf5')
		self.model_Dense169 = keras.models.load_model(r'weights/DenseNet169_E10.hdf5')
...
<<<<<<< HEAD
	lis = glob.glob(r'E:\0NewDev\SIH\Datasetes\Day1\*.jpg')
